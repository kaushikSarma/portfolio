...
class Experience extends Component {
    constructor(props) {
        ...
        this.state = {
            experiences: [
                {
                    'title': 'Blockchain Developer, Accenture (December 2018 - Present)',
                    'description': 'Exploring current trends in distributed ledger technology. Worked on creating smart contracts in Corda, developing microservices for Corda nodes in Springboot. Deploying corda nodes to Kubernetes cluster on Cloud platform and managing configurations with helm.'
                },
                {
